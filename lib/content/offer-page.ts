...
export const offerFaq = [
  {
    question: "Do I need to already own land to submit a brief?",
    answer:
      "No. A significant number of our clients come to us before they have secured a site. We can advise on what to look for and what to avoid when evaluating land for a Soleta home — and we can begin shaping the project brief in parallel with your land search.",
  },
  {
    question: "Can I enquire if I am still comparing options?",
    answer:
      "Yes. If you are comparing Soleta with other builders or approaches, a Private Consultation is a useful way to get a concrete sense of what a Soleta project would actually involve — scope, timeline, and direction — before committing. We expect this and will be direct about what Soleta can and cannot offer for your brief.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "None. A Private Consultation is produced at no charge. It carries no obligation on your part and does not constitute a contract or binding estimate. It is the starting point of a conversation, not the end of one.",
  },
];
