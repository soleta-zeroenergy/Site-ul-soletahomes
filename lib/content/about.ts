...
export const aboutSupportBlock = {
  eyebrow: "The founder",
  body: "Cătălin Butmălai is the founder and design director of Soleta. He came to architecture through construction, not the other way around. That sequence — building first, designing from accumulated material knowledge second — defines the way Soleta approaches every project. He is a disciple of Justin Capră, one of Romania's most original engineering minds, from whom he learned that originality is not a function of geography.",
};

/* ── Timeline (kept for rendering) ───────────────────────────────────────── */

export const companyTimeline = [
  {
    year: "2011",
    event: "Development begins",
    detail: "Cătălin Butmălai begins developing the Soleta ZeroEnergy concept within the Justin Capră Foundation for Inventics and Sustainable Technologies.",
  },
  {
    year: "2013",
