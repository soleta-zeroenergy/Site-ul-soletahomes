...
export const homeHousePlansBridge = {
  eyebrow:  "Models & EasyKit",
  heading:  "Looking for EasyKit options, plan packages or project package guidance?",
  body:     "SoletaHousePlans is the official Soleta platform for EasyKit packages, house plans, package guidance and project enquiries.",
  ...
  projects: [
    {
      ...
      imageAlt: "Soleta Aquarius — alpine Signature private residence",
    ...
    },
    {
      ...
      imageAlt: "Soleta Aurora — pre-alpine Signature home",
      title:    "Soleta Aurora",
      location: "Europe",
      category: "Private Residence",
      year:     2022,
      href:     "/built-projects/private-residences/soleta-aurora",
    },
    {
      imageSrc: "https://img.soletahomes.com/sh-home-built-work-Life-06-800x600-4x3.webp",
      imageAlt: "House Soleta Fly — holiday home",
      title:    "House Soleta Fly",
      location: "Europe",
      category: "Holiday Home",
      year:     2024,
      href:     "/built-projects/holiday-homes/house-soleta-fly",
    },
  ],
