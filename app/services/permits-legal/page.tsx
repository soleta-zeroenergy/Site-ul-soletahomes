...
const breadcrumb = breadcrumbSchema([
  ...
  { name: svc.label, href: "/services/permits-legal" },
]);
      ...
      >
        <div className="container-narrow">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-[120px_1fr]">
            <span className="font-ui text-[0.625rem] font-medium uppercase tracking-[0.14em] text-[var(--color-brand)] md:pt-1" aria-hidden="true">Important</span>
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr]">
          ...
          >
            <Image
              ...
              alt="Soleta Signature — technical documentation for planning authorities"
              fill
              className="object-cover"
