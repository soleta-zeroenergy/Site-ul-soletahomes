...
export default function PressPage() {
  return (
    <>
      ...
      >
        <Image
          src="https://img.soletahomes.com/hero_press_media_3000x975.webp"
      ...
      >
        <div className="container-narrow flex flex-col gap-10">
          <Image
            src="https://img.soletahomes.com/Working%20on%20a%20story.webp"
            alt="Working on a story — Soleta press and media"
            width={0}
            height={0}
