...
export const metadata: Metadata = {
  ...withCanonical("/built-projects/hospitality-resorts"),
...
export default function HospitalityResortsPage() {
  const categoryProjects = projects.filter((p) => p.category === "hospitality");
    ...
    <>
      ...
      >
        <div className="container-narrow">
          ...
          <span className="eyebrow mb-4 block">Hospitality & Resorts</span>
          <h1 className="mb-6 max-w-2xl">Timber hospitality, built at scale</h1>
          <p className="subtitle max-w-xl">
            Boutique hotels, eco-resorts and lodge clusters. The Soleta modular system makes it possible to build high-quality hospitality at speed — without compromising on materials or architecture.
          </p>
        </div>
      </section>
