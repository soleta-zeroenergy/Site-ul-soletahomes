...
const faqSchema = faqPage([
  {
    ...
    a: "Soleta offers three collection directions. Signature: the most architecturally ambitious work, designed for exceptional sites and clients who want a home that will never be repeated — including select projects that begin with an external architect's design. Classic: timeless post-and-beam construction with generous proportions and enduring materials. Holiday & Retreat: compact architecture for remote and rural settings.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Each collection design is a starting point, not a fixed product. Most clients adapt their chosen collection to their site and brief through the design development phase. Clients with significantly different requirements are typically better served by the Soleta Signature path.",
  },
  {
